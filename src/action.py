...
conflict with the First or Second Law."""))
    ...
    simple_command(_('what is camp like'),_('some would say super fun and crafty'))
    simple_command(_('what time does camp start'),_('camp starts at 9 am sharp'))
    simple_command(_('what time does camp end'),_('camp ends at 3 pm there abouts'))
    simple_command(_('when does camp start'),_('there are three weeks for camp starting the second week in august'))
    simple_command(_('do we get to go outside'),_('for sure. there are weekly field trips and daily outdoor run around time'))
    simple_command(_('where is camp'),_('our location is right near franklin avenue and eastern parkway'))
    simple_command(_('will I get to code'),_('for sure'))
    simple_command(_('what kind of things will I do in camp'),_('coding, making, and general good time'))
    simple_command(_('how much does camp cost'),_('youre in luck. camp is 500 dollars per week but this week we are having a 50 dollar off summer sale. act fast to save your spot.'))
    simple_command(_('how much is camp cost'),_('youre in luck. camp is 500 dollars per week but this week we are having a 50 dollar off summer sale. act fast to save your spot.'))
    simple_command(_('who are the teachers'),_('camp is run by matt, david, and loreto. they are local parents who are educators and makers. visit our website to learn more.'))
    simple_command(_('what are the sessions'),_('week 0 is all about robots week 1 is about puzzles and escaping the camp while week 2 is tech for good. How can we use technology to help those around us.'))
    simple_command(_('what happens at camp'),_('coding, making, and general good time'))
    simple_command(_('is camp fun'),_('do computers have motherboards?'))
    simple_command(_('what do we eat'),_('campers are asked to pack a lunch but healthy snacks are provided'))
    simple_command(_('will we have outdoor activities'),_('Indeed! campers go outside after lunch everyday and fieldtrips in the community are planned for each week.'))
